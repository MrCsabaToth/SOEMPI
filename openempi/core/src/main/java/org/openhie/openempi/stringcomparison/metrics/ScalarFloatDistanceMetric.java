...
public class ScalarFloatDistanceMetric extends AbstractDistanceMetric
{
	public ScalarFloatDistanceMetric() {
	}
	...
	public double score(Object value1, Object value2) {
		...
		if (value1 instanceof Float) {
			...
			try {
				v1 = Float.valueOf(value1.toString());
			}
		...
		if (value2 instanceof Float) {
			...
			try {
				v2 = Float.valueOf(value2.toString());
			}
			catch (java.lang.NumberFormatException e) {
			}
		}
