...
public class ProbabilisticMatchingWithScaledScoresService extends ProbabilisticMatchingServiceBase
{
			...
			MatchConfiguration matchConfig, int pairNumber)
	{
		...
		//ContinuousExpectationMaximizationEstimator estimator = new ContinuousExpectationMaximizationEstimator();
		//estimator.estimateMarginalProbabilities(fellegiSunterParams, matchConfig, pairs);
	}
}
