...
public abstract class AbstractStringTransformationFunction extends AbstractTransformationFunctionBase
{
	protected final Log log = LogFactory.getLog(getClass());

	public AbstractStringTransformationFunction() {
	}
	
	protected byte[] byteTransformCore(byte[] field, Map<String, Object> parameters) {
		throw new UnsupportedOperationException("Function " + getName() + " is not byte array type transformation");
	}
